                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" action="{{route('stocker')}} " enctype="multipart/form-data">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="medias d-flex ml-4">
                                    <div class="mt-4 d-flex unDoc">
                                    ...
                                    <div class="mt-4 d-flex unDoc">
                                        ...
                                        <input name="video" type="file" id="video" accept="video/*"  hidden/>
                                    ...
                                    <div class="mt-4 d-flex unDoc">
                                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                           ...
                                           <input name="documents" type="file" id="documents" accept=".doc,.docx,.xml,.pdf,.txt"  hidden/>
